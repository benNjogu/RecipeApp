...
public class RecipeToRecipeCommand implements Converter<Recipe, RecipeCommand>{
	...
	private IngredientTongredientCommand ingredientsConverter;
	private CategoryToCategoryCommand categoryConverter;
	
	public RecipeToRecipeCommand(NotesToNotesCommand notesConverter, IngredientTongredientCommand ingredientsConverter,
